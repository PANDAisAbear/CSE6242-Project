...
b. Copy local host 5000 link into Firefox browser and load page
c. From the drop-down menus, select User ID and Start and End locations
d. Click "Create Recommendations" button
e. Refresh page to show route with 3 restaurant recommendations
-Can mouseover markers to display restaurant name above the marker
f. Click "View Visualizations" on the top left to view summary comparison visualizations
-Can mouseover bars to show rating and total reviews
-Can click restaurant name to open Yelp page
g. Click "View Map" to return to map and start over
